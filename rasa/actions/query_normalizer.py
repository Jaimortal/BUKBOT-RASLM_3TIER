...
class QueryNormalizer:
    ...
    PHRASE_CONCEPTS: Dict[str, str] = {
        ...
        "buksu-cat": "buksu cat college admission test",
        "buksucat": "buksu cat college admission test",
        "cat exam": "cat exam college admission test buksu cat",
        "cat examination": "cat examination college admission test buksu cat",
        "cat testing": "cat testing college admission test buksu cat",
        "admission test": "admission test college admission test buksu cat",
        "admission testing": "admission testing college admission test buksu cat",
        ...
        "dad on": "bring dad on dad-on dalhon",
        "dad-on": "bring dad on dad-on dalhon",
        "dalhon": "bring dad on dad-on dalhon",
    ...
    TOKEN_CONCEPTS: Dict[str, str] = {
        ...
        "kailangan": "requirements documents need",
        "dad-on": "bring dad on dad-on dalhon dala",
        "dad": "bring dad on dad-on dalhon dala",
        "dalhon": "bring dad on dad-on dalhon dala",
        "dala": "bring dad on dad-on dalhon dala",
        "dadon": "bring dad on dad-on dalhon dala",
