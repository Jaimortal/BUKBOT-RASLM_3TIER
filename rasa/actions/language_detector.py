...
BISAYA_WORDS = [
    "asa", "unsay", "unsa", "ngano", "diin", "kinsa", "kanus-a", "kanusa", "pila",
    ...
    "maayo", "kaninyo", "kanimo", "diha", "jud", "mani", "kini", "karon",
    ...
    "mahuman", "mahoman", "humana", "klasi", "palitanan", "ihatag", "ehatag", "hatagan"
]
